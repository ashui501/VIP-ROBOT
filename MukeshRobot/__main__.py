...
PM_START_TEXT = """ 
*ʜᴇʏ*  {} ,[⚡]({}) 
**I ᴀᴀᴍ {}, Tʜᴇ ᴘᴏᴡᴇʀғᴜʟ ʙᴏᴛ
ᴛᴏ ᴍᴀɴᴀɢᴇ ᴀɴᴅ sᴀᴠᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ғʀᴏᴍ ᴇɴᴇᴍɪᴇs. 
I ᴀᴍ ʙᴀsᴇᴅ ᴏɴ ᴀɴ ᴀɴɪᴍᴇ ᴄᴀʟʟᴇᴅ jututsu kaisen.I ʜᴀᴠᴇ ᴛʜᴇ ᴘᴏᴡᴇʀ ᴛᴏ sᴀᴠᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴍʏ powers""" 
...
╔═════ஜ۩۞۩ஜ═════╗
  ...
  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [dynamic dynasty](https://t.me/uchiha_itachi_god_akatusuki)♨️
